...
DefNode(GeometryNode, GEO_NODE_UNPACK_ARMATURE, def_geo_unpack_armature,"UNPACK_ARMATURE", UnpackArmature, "Unpack Armature", "Unpacks an armature object for use in geometry nodes")
DefNode(GeometryNode, GEO_NODE_GET_BONE_BY_NAME, def_get_bone_by_name,"GET_BONE_BY_NAME", GetBonebyName, "Get Bone by Name", "Selects a bone from an armature")
